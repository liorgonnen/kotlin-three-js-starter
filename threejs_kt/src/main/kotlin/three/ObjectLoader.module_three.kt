...
open external class ObjectLoader(manager: LoadingManager = definedExternally) : Loader {
    open fun <T : Object3D> load(url: String, onLoad: (obj: T) -> Unit = definedExternally, onProgress: (event: ProgressEvent) -> Unit = definedExternally, onError: (event: dynamic /* Error | ErrorEvent */) -> Unit = definedExternally)
    ...
    open fun parseImages(json: Any, onLoad: () -> Unit): `T$41`
