...
open external class CubeCamera(near: Number = definedExternally, far: Number = definedExternally, cubeResolution: Number = definedExternally, options: WebGLRenderTargetOptions = definedExternally) : Object3D {
